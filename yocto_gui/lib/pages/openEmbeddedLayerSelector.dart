              ...
              Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        fillColor: Color(0xffD9D9D9).withOpacity(0.14),
                        prefixIcon: Icon(
                          Icons.search,
                          color: Colors.white,
                        )),
            ...
            Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton2(
                    items: global.allLayers
                        .map((e) => DropdownMenuItem<String>(
                            value: e.branchName, child: Text(e.branchName)))
                        .toList(),
                    hint: Text('Branch: ${selectedBranch.branchName}',
                        style: TextStyle(color: Colors.white)),
                    dropdownDecoration: BoxDecoration(color: Color(0xff373737)),
                    alignment: Alignment.centerLeft,
                    value: selectedBranch.branchName,
                    style: TextStyle(color: Colors.white),
                    onChanged: (value) {
                      setState(() {
                        selectedBranch = global.allLayers[global.allLayers
                            .indexWhere(
                                (element) => element.branchName == value)];
                      });
                    },
                  ),
                )),
            Expanded(
                child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: selectedBranch.layers
                            .map((e) => Container(
